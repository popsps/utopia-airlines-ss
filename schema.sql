...
START TRANSACTION;
USE `utopia`;
INSERT IGNORE INTO utopia.passenger
    (booking_id, given_name, family_name, dob, gender, address)
VALUES (1, 'fname 1', 'lname 1', '1900-10-20', 'male', 'address 1');
INSERT IGNORE INTO utopia.passenger
    (booking_id, given_name, family_name, dob, gender, address)
VALUES (1, 'fname 2', 'lname 2', '2000-10-20', 'male', 'address 2');
INSERT IGNORE INTO utopia.passenger
    (booking_id, given_name, family_name, dob, gender, address)
VALUES (1, 'fname 3', 'lname 3', '2010-10-20', 'female', 'address 3');
INSERT IGNORE INTO utopia.passenger
    (booking_id, given_name, family_name, dob, gender, address)
VALUES (2, 'fname 1', 'lname 1', '1900-10-20', 'male', 'address 1');
INSERT IGNORE INTO utopia.passenger
    (booking_id, given_name, family_name, dob, gender, address)
VALUES (3, 'fname 4', 'lname 4', '2000-10-20', 'male', 'address 4');
COMMIT;